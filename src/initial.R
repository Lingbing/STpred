...
library(ggplot2, mvtsplot, reshape2)
...
m = 240 # number of months for modeling 
s = 28 # number of stations for modeling
subdata <- Cut(hqmr.cube)[1:m, c(1:s)]
mdbdata <- subdata
rm(subdata)
...
STmdb <- createSTdata(obs, covars, n.basis = 2)
print(STmdb)
